...
#define CS_GPIO_PORT  PORTB
#define CS_PIN        PORTB.2
#define SS_SELECT()   CS_PIN=0	//Enable spi
#define SS_DESELECT() CS_PIN=1	//Disable spi
...
// PHY registers
#define PHCON1           0x00
#define PHSTAT1          0x01ENC28J60_readPhy
#define PHHID1           0x02
#define PHHID2           0x03
#define PHCON2           0x10
#define PHSTAT2          0x11
...
static uint16_t ENC28J60_readPhy(uint8_t addres) //ham doc PHYENC28J60_readPhy
